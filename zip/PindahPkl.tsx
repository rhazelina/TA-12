...
export default function PindahPkl() {
    ...
    return (
        <div className="min-h-screen bg-[#f8f9fa] text-[#333] font-['Poppins']">
            <div className="max-w-[1200px] mx-auto px-5 py-10">

                {/* HEADER */}
                <header className="flex justify-between items-center mb-10 border-b-2 border-[#eee] pb-5">
                    <div className="brand-logo">
                        <h2 className="text-[#641E20] text-[28px] font-bold">
                            Magang<span className="text-[#333]">Hub</span>
                        </h2>
                        <p className="text-[13px] text-[#777]">Sistem Informasi Manajemen PKL</p>
                    </div>
                </header>
